...
\forfatter{Sune Andreas Dybro Debel \quad {\small \texttt{nkz509@alumni.ku.dk}}}%
\dato{\today}%
\vejleder{\textbf{Supervisor:} Dirk Hovy \quad {\small \texttt{dirk.hovy@di.ku.dk}}} %  Findes kun under 'titelside'
...
\input{abstract}
\pagebreak
\newgeometry{twoside, inner=5cm, outer=3cm}
